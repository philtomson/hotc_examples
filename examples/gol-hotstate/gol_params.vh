...
localparam NUM_STATES = 236;
localparam NUM_VARS = 12;
localparam NUM_VARS_ADDR_BITS = 12;
localparam NUM_INPUT_BITS = 20;
localparam NUM_INPUT_VARS = 13;
localparam NUM_WORDS = 457;
localparam NUM_ADR_BITS = 9;
...
localparam TIM_MEM_WORDS = 6;
localparam TIM_EX_WORDS = 0;
localparam EXPR_SEL_BITS = 7;
localparam NUM_EXPRS = 64;
localparam NUM_CONST_ARRAYS = 4;
localparam NUM_COMPARATORS = 0;
localparam CMP_VARSEL_BASE = 0;
localparam SMDATA_WIDTH = 504;

localparam STATE_WIDTH = 236;
localparam MASK_WIDTH = 236;
localparam JADR_WIDTH = 9;
