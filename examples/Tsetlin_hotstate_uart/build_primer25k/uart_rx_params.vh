...
localparam NUM_VARS = 1;
localparam NUM_VARS_ADDR_BITS = 1;
localparam NUM_INPUT_BITS = 1;
localparam NUM_INPUT_VARS = 1;
localparam NUM_WORDS = 66;
localparam NUM_ADR_BITS = 7;
localparam NUM_VARSEL_BITS = 1;
localparam VD_ROW_WIDTH = 2;
...
localparam CMP_VARSEL_BASE = -1;
localparam SMDATA_WIDTH = 38;

localparam STATE_WIDTH = 10;
localparam MASK_WIDTH = 10;
localparam JADR_WIDTH = 7;
localparam VARSEL_WIDTH = 1;
