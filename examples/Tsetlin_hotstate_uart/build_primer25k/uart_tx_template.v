// Auto-generated Verilog module for uart_tx
...
wire [8:0] variables_bus;
wire [1:0] states_bus;

assign tx_bit = states_bus[0];
assign tx_busy = states_bus[1];
assign states_out = states_bus;

assign variables_bus = {tx_data, tx_start};
...
hotstate #(
    ...
    .NUM_SWITCH_BITS(0),
    .MCFILENAME("build_primer25k/uart_tx_smdata.mem"),
    .VRFILENAME("build_primer25k/uart_tx_vardata.mem"),
    .TIFILENAME("build_primer25k/uart_tx_timdata.mem"),
    .SWFILENAME("build_primer25k/uart_tx_switchdata.mem"),
    .STACK_DEPTH(4),
    .STANDALONE(1),
    .DUAL_BANK(0),
    .COMPILER_MODE(0),
