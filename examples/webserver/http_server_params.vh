...
localparam NUM_VARS = 2;
localparam NUM_VARS_ADDR_BITS = 2;
localparam NUM_INPUT_BITS = 10;
localparam NUM_INPUT_VARS = 3;
...
localparam SWITCH_OFFSET_BITS = 12;
localparam TIM_MEM_WORDS = 2;
localparam TIM_EX_WORDS = 0;
localparam EXPR_SEL_BITS = 0;
localparam NUM_EXPRS = 0;
localparam NUM_CONST_ARRAYS = 0;
localparam NUM_COMPARATORS = 14;
localparam CMP_VARSEL_BASE = 4;
localparam SMDATA_WIDTH = 43;

localparam STATE_WIDTH = 11;
localparam MASK_WIDTH = 11;
