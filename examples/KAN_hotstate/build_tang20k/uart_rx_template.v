...
hotstate #(
    ...
    .NUM_SWITCH_BITS(0),
    .MCFILENAME("build_tang20k/uart_rx_smdata.mem"),
    .VRFILENAME("build_tang20k/uart_rx_vardata.mem"),
    .TIFILENAME("build_tang20k/uart_rx_timdata.mem"),
    .SWFILENAME("build_tang20k/uart_rx_switchdata.mem"),
    .STACK_DEPTH(4),
    .STANDALONE(1),
    .DUAL_BANK(0),
    .COMPILER_MODE(0),
