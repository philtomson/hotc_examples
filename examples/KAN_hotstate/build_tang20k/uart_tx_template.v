...
hotstate #(
    ...
    .NUM_SWITCH_BITS(0),
    .MCFILENAME("build_tang20k/uart_tx_smdata.mem"),
    .VRFILENAME("build_tang20k/uart_tx_vardata.mem"),
    .TIFILENAME("build_tang20k/uart_tx_timdata.mem"),
    .SWFILENAME("build_tang20k/uart_tx_switchdata.mem"),
    .STACK_DEPTH(4),
    .STANDALONE(1),
    .DUAL_BANK(0),
    .COMPILER_MODE(0),
